...
<head>
    ...
    <title>お知らせ｜ゑびすグループ「満てん」「ゑびす」「牛粋」「ぶたと和いん」宮城県の飲食店グループ</title>
...
<body>
    ...
    <section class="news">
        <div class="inner">
            <ul class="news-tab">
                <li class="tab-item active">ALL</li>
                <li class="tab-item group">EBISU <br>GROUP</li>
                <li class="tab-item daichi">EBISU <br>MEAT <br>DAICHI</li>
            ...
            <nav class="pagination">
                <div class="nav-links">
                    <ul>
                        <li><a href="" class="prev">前の10件</a></li>
                        <li><a href="" class="page-numbers">1</a></li>
                        <li><a href="" class="page-numbers active">2</a></li>
                        <li><a href="" class="page-numbers">3</a></li>
                        <li><a href="" class="page-numbers">4</a></li>
                        <li><a href="" class="page-numbers">5</a></li>
                        <li><a href="" class="next">次の10件</a></li>
                    </ul>
                </div>
            </nav>
        </div>
