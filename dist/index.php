...
<body>
    ...
    <div class="mv">
        ...
        <div id="mv_scroll" class="mv-scroll"><img src="images/mv_scroll_text.svg" alt="SCROLL"></div>
    </div>
    ...
    <section class="info-meat">
        <div class="wrap">
            ...
            <div class="info-bg-img img04 fadein ani05"><img src="images/top_info_meat_bg_04.png" alt="イラスト"></div>
        </div>
    </section>
    ...
    <section class="corporate">
        <div class="wrap">
            ...
            <div class="block">
                ...
                <div id="slider_daichi" class="img-area slider-fade">
                    <div class="slide">
                        <img src="images/top_corporate_daichi_photo_01.jpg" alt="">
                    </div>
                    <div class="slide">
                        <img src="images/top_corporate_photo_none.png" alt="">
                    </div>
                </div>
            </div>
            <div class="block">
                ...
                <div id="slider_factory" class="img-area slider-fade">
                    <div class="slide">
                        <img src="images/top_corporate_factory_photo_01.jpg" alt="">
                    </div>
                    <div class="slide">
                        <img src="images/top_corporate_photo_none.png" alt="">
                    </div>
            ...
            <div class="block">
                ...
                <div id="slider_deli" class="img-area slider-fade">
                    <div class="slide">
                        <img src="images/top_corporate_del_photo_01.jpg" alt="">
                    </div>
                    <div class="slide">
                        <img src="images/top_corporate_photo_none.png" alt="">
                    </div>
            ...
            <div class="block">
                ...
                <div id="slider_dining" class="img-area slider-fade">
                    <div class="slide">
                        <img src="images/top_corporate_dining_photo_01.jpg" alt="">
                    </div>
                    <div class="slide">
                        <img src="images/top_corporate_photo_none.png" alt="">
                    </div>
            ...
            <div class="block">
                ...
                <div id="slider_liquor" class="img-area slider-fade">
                    <div class="slide">
                        <img src="images/top_corporate_liquor_photo_01.jpg" alt="">
                    </div>
                    <div class="slide">
                        <img src="images/top_corporate_photo_none.png" alt="">
                    </div>
        ...
        <div class="wrap">
            ...
            <div class="inner">
                <div class="block">
                    ...
                    <div class="logo"><img src="images/logo_shop_sekimura-farm.svg" alt=""></div>
                    <p>漢方和牛＆漢方三元豚が<br>ご自宅でお手軽にお召し上がりいただけます。</p>
                </div>
                <div class="block">
                    <img src="images/top_shop_photo_02.jpg" alt="イメージ写真">
                    <div class="logo"><img src="images/logo_shop_kitchen.svg" alt=""></div>
                    <p>宮城県栗原の地元食材にこだわった商品を<br>取り扱っております。</p>
                </div>
                <div class="block">
                    <img src="images/top_shop_photo_03.jpg" alt="イメージ写真">
            ...
            <picture>
                ...
                <img src="images/top_shop_photo_04.jpg" alt="イメージ写真">
            </picture>
